...
class BillEntryPaginateForm implements Form
{
    /**
    ...
    {
        $this->query->addFilterGreater($this->billModel->getEntryIdName(), 0);
    }
    ...
    {
        $attributesToColumnsMap = $this->billModel->mapAttributesToColumns();
